...
$ResNom=mysqli_fetch_array(mysqli_query($conn, "SELECT Id, concat_ws(' ', Nombre, Apellidos) AS Nombre FROM pacientes WHERE Id='".$_POST["id"]."' LIMIT 1"));
...
$cadena='<div class="c100 card">
            ...
            <form name="ffoto" id="ffoto" enctype="multipart/form-data">
                ...
                <label for="custom-file-upload" class="filupp">
                        ...
                        <input type="file" name="fpaci" accept=".jpg,.png" id="custom-file-upload"/>
                    </label>
                    <input type="hidden" name="hacer" id="hacer" value="adfoto">
                    <input type="hidden" name="idpaciente" id="idpaciente" value="'.$ResNom["Id"].'"> 
                    <input type="hidden" name="buscaidpaciente" id="buscaidpaciente" value="'.$ResNom["Id"].'"> 
                    <input type="hidden" name="buscar" id="buscar" value="'.$ResNom["Id"].'"> 
